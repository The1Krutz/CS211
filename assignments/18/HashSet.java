 ...
 *
 * HashSet<E> class
 * implement toString2() - builds a string output that demonstrates the internal storage of a hash set by displaying where each value is in the underlying array
 * 
 */
